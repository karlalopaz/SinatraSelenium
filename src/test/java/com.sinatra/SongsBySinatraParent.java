...
public class SongsBySinatraParent extends  LikeSongParent
{
    ...
    public void validarHomePage(String welcomeMessage)
    {
    ...
    public void validarMensajeLogin(String mensajeBienvenida)
    {
    ...
    public void validarSongsPage ()
    {
        ...
        if(songsTitle.isDisplayed()  && currentUrl.endsWith("songs") && currentClass.equals("current") && listaCanciones.size() > 0)
        {
